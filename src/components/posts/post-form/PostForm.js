...
import { updateModalIsFeelingOpen, updateModalIsGifModalOpen } from '@redux/reducers/modal/modal.reducer';
...
const PostForm = () => {
    ...
    const { type, isOpen, isGifModalOpen, isFeelingSelectOpen } = useSelector(state => state.modal)
    const openPostModal = () => {
                ...
                <div className="post-form-row">
                    ...
                    <div className="post-form-body">
                        ...
                        <ul className="post-form-list" data-testid="list-item">
                            ...
                            <li className="post-form-list-item" onClick={() => openModalAndFeeling()}>
